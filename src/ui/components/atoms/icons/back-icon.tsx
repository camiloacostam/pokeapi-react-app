...
export function BackIcon({ size = 1 }: IBackIconProps) {
  return (
    <svg
      width={size * 30}
      height={size * 30}
      ...
      <defs>
        ...
        >
          ...
          <feMorphology
            ...
            operator="dilate"
            in="SourceAlpha"
            result="effect1_dropShadow_2283_108"
          />
          <feOffset dy="1" />
          ...
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_2283_108"
            result="shape"
          />
        </filter>
      </defs>
